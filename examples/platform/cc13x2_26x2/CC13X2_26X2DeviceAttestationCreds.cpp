...
// #error "compiler currently not supported"SN
...
// #if defined(__GNUC__)
// const uint8_t __attribute__((section( ".dac_cert"))) __attribute__((used)) gDacCert[] =
// #else
...
// #if defined(__GNUC__)
// const uint8_t __attribute__((section( ".pai_cert"))) __attribute__((used)) gPaiCert[] =
// #else
